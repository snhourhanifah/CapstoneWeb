...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2017 at 05:17 AM
...
(18, 'FfGgXxYyPQ', 1, 28, 2016, 'Summer', NULL);
...
(27, 'Part II', 'Putang Ina'),
(28, 'Computer Networks', 'IT 122');
...
(35, 10, NULL, '2015-07-20', NULL, 5, 'Take This', 'inactive', '22:00\n', '19:32', 19, 0),
(36, 8, NULL, '2015-07-20', NULL, 5, 'Take This 2', 'inactive', '22:00\n', '19:32', 5, 0),
(37, 8, NULL, '2015-07-20', NULL, 5, 'Bago', 'inactive', '22:00\n', '19:32', 5, 0),
(38, 10, NULL, '2015-07-20', NULL, 3, 'Tsu Tsu', 'inactive', '22:00\n', '19:32', 19, 0),
(39, 8, NULL, '2015-07-30', NULL, 4, 'check check', 'inactive', '11:29', '15:00', 5, 0),
(40, 8, NULL, '2015-08-12', NULL, 0, 'IT 192 Usability Test Exam', 'inactive', '10:00', '10:45', 5, 0),
(41, 10, NULL, '2015-08-12', NULL, 0, 'Usabilty Text Exam', 'inactive', '10:00', '10:45', 19, 0),
(42, 11, NULL, '2015-08-17', NULL, 10, 'Exam for Usability Testing', 'inactive', '10:00', '10:45', 22, 0),
(43, 10, NULL, '2015-08-17', NULL, 10, 'CSc 101 - Eeff Exam', 'inactive', '13:00', '14:00', 19, 0),
(44, 12, NULL, '2015-11-02', NULL, 0, '192 Capstone Exam', NULL, '21:00', '21:45', 24, 0),
(45, 12, NULL, '2015-11-02', NULL, 0, '192 Capstone Exam', NULL, '21:00', '21:30', 24, 0),
(47, 12, NULL, '2015-11-03', NULL, 10, 'IT 192 - Capstone Exam', 'active', '11:25', '11:53', 24, 1),
(48, 8, NULL, '2017-01-13', NULL, 4, 'An Exam Title', 'inactive', '11:00', '11:30', 5, 0),
(61, 12, NULL, '2017-02-08', NULL, 10, 'Fore Testing Feb 8', 'active', '10:00', '12:00', 25, 3);
...
(61, 319, '2017-02-08', '11:00:24', 2, 3, 9, 16),
(61, 293, '2017-02-08', '11:51:34', 3, 2, 13, 16),
(61, 294, '2017-02-08', '11:55:57', 3, 2, 8, 16),
(0, 294, '2017-02-08', '12:00:59', 0, 0, 0, 0),
(0, 294, '2017-02-08', '12:01:56', 0, 0, 0, 0);
...
(39, 32, 'False', 'Correct'),
(40, 33, 'Local Area Network', 'Correct'),
(41, 34, 'Information Technology', 'Correct'),
(42, 35, 'Waterfall', 'Correct'),
(43, 36, 'nedlk', 'Correct'),
(44, 37, '2', 'Correct');
...
(33, 'What does LAN mean?', 'Identification', 2, 1, 28),
(34, 'What is the meaning of IT?', 'Identification', 3, 1, 26),
(35, 'SDLC Stands for?', 'Identification', 2, 1, 21),
(36, 'sarwjf', 'Identification', 2, 1, 26),
(37, 'lknfel', 'Identification', 2, 1, 21);
...
--
-- Table structure for table `studentexam_record`
--

CREATE TABLE IF NOT EXISTS `studentexam_record` (
...
--
-- Dumping data for table `studentexam_record`
--

INSERT INTO `studentexam_record` (`record_id`, `questionid`, `answer`, `userid`) VALUES
(1, 3, 'HTML', 319),
(2, 2, 'False', 319),
(3, 7, 'variable', 319),
(4, 1, 'method', 319),
...
(1, 'Sittie Nhourhanifa', 'Guro', 'Mamailao', 'Faculty', '201027511', '', 'ecoyguro'),
...
(318, 'Monaifah', 'H. Abdulcader', 'Asugar', 'Faculty', '1058626', '', 'hm'),
...
(447, 'Mermellah', 'ANGNI', 'Magandia', 'Student', '201401208', '', 'amm'),
(449, 'Saida', 'OMAR', 'Guro', 'Student', '201246532', '', 'osg'),
(450, 'Johaima', 'PANSAR', 'G', 'Student', '200158354', '', 'pjg'),
(451, 'Roy', 'RAPOSON', 'Roy', 'Student', '201317173', '', 'rrr'),
(452, 'Muhammad', 'SALIC', 'Macasasa', 'Student', '201402496', '', 'smm'),
(453, 'Jehan', 'SANI', 'Colmpang', 'Student', '201403297', '', 'sjc'),
(454, 'Leo', 'UNDUNA', 'O', 'Student', '201031823', '', 'ulo'),
(455, 'Sittie', 'USMAN', 'Lao', 'Student', '201027036', '', 'usl'),
(456, 'Maria', 'Mercedes', 'Dyokno', 'Faculty', '2012123456', '', 'maria_d');

-- --------------------------------------------------------

--
-- Stand-in structure for view `viewstudentexamrecord`
--
CREATE TABLE IF NOT EXISTS `viewstudentexamrecord` (
`questionid` int(11)
,`description` text
,`weight` int(11)
,`examid` int(11)
...
--
-- Stand-in structure for view `view_examquestions`
--
CREATE TABLE IF NOT EXISTS `view_examquestions` (
`examid` int(11)
,`questionid` int(11)
,`description` text
,`questiontype` text
...
--
-- Stand-in structure for view `view_myactiveexams`
--
CREATE TABLE IF NOT EXISTS `view_myactiveexams` (
`examid` int(11)
,`title` text
,`expiredate` date
,`items` int(11)
...
--
-- Stand-in structure for view `view_options`
--
...
--
-- Structure for view `viewstudentexamrecord`
--
DROP TABLE IF EXISTS `viewstudentexamrecord`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewstudentexamrecord` AS select `q`.`questionid` AS `questionid`,`q`.`description` AS `description`,`q`.`weight` AS `weight`,`eq`.`examid` AS `examid`,`mco`.`optioncontent` AS `optioncontent`,`mco`.`optiontype` AS `optiontype`,`ser`.`answer` AS `answer`,`ser`.`userid` AS `userid` from (((`questions` `q` join `examquestions` `eq` on((`eq`.`questionid` = `q`.`questionid`))) join `multiplechoiceoptions` `mco` on((`mco`.`question` = `q`.`questionid`))) join `studentexam_record` `ser` on((`ser`.`questionid` = `q`.`questionid`)));

-- --------------------------------------------------------

--
-- Structure for view `view_examquestions`
--
DROP TABLE IF EXISTS `view_examquestions`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_examquestions` AS select `eq`.`examid` AS `examid`,`eq`.`questionid` AS `questionid`,`q`.`description` AS `description`,`q`.`questiontype` AS `questiontype`,`q`.`weight` AS `weight`,`o`.`optioncontent` AS `answer`,`o`.`optiontype` AS `optiontype` from ((`examquestions` `eq` join `questions` `q` on((`eq`.`questionid` = `q`.`questionid`))) join `multiplechoiceoptions` `o` on((`o`.`question` = `q`.`questionid`)));

-- --------------------------------------------------------

--
-- Structure for view `view_myactiveexams`
--
DROP TABLE IF EXISTS `view_myactiveexams`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_myactiveexams` AS select `e`.`examid` AS `examid`,`e`.`title` AS `title`,`e`.`expiredate` AS `expiredate`,`e`.`items` AS `items`,`e`.`examdate` AS `examdate`,`e`.`status` AS `status`,`e`.`start` AS `start`,`e`.`end` AS `end`,`cs`.`myclassid` AS `myclassid`,`cs`.`myid` AS `myid`,`c`.`section` AS `section`,`crs`.`coursecode` AS `coursecode` from (((`exam` `e` join `class_student` `cs` on((`e`.`exam_recipient` = `cs`.`myclassid`))) join `class` `c` on((`cs`.`myclassid` = `c`.`classid`))) join `course` `crs` on((`crs`.`courseid` = `c`.`courseid`)));

-- --------------------------------------------------------

--
-- Structure for view `view_options`
--
DROP TABLE IF EXISTS `view_options`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_options` AS select `q`.`questionid` AS `questionid`,`mco`.`optionid` AS `optionid`,`mco`.`optioncontent` AS `optioncontent`,`mco`.`optiontype` AS `optiontype` from (`questions` `q` join `multiplechoiceoptions` `mco` on((`q`.`questionid` = `mco`.`question`)));
